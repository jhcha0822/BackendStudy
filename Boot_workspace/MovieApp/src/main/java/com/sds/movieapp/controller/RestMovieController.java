...
public class RestMovieController {
	...
	public ResponseEntity regist(MemberDoc member, MovieDoc movie, CommentsDoc comments) {
		...
		// Komoran 동작 테스트
		KomoranResult result = komoran.analyze(comments.getContent()); // 영화평을 형태소 단위로 분석
