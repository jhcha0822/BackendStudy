...
import com.sds.recommendapp.model.movie.MovieService;
...
public class MenuAspect {
	...
	// 일반 컨트롤러에 대해 AOP 적용
	@Pointcut("execution(public * com.sds.recommendapp.controller..*(..))")
	public void includeExecution() {} // pointcut을 쓰기 위한 메서드. 로직을 작성하지 않음
	
	// 아래 패턴(RestController)은 제외
	@Pointcut("!execution(public * com.sds.recommendapp.controller.Rest*Controller.*(..))")
