                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="product__item">
                            	<!-- D:\MULTICAMPUS\Spring_workspace\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\Mall\resources\product_img\ -->
                                <!-- div class="product__item__pic set-bg" data-setbg="/static/shop/img/shop/<%=product.getFilename()%>" -->
